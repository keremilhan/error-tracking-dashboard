...
const SignUp: React.FC<{ toggleHasAccount: () => void }> = ({ toggleHasAccount }) => {
    ...
    const handleSignUp = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (error.response && error.response.data && error.response.data.errors) {
                ...
                setErrors((prev: Errors | null) => ({ name: prev?.name, password: prev?.password, email: error.response.data.msg }));
            }
        } finally {
            hideLoading();
        }
